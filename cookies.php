...
<body>
    ...
    <section class="pages">
        <div class="container">
            <span class="section-tag" data-aos="fade-down">Legal Compliance</span>
            <h1 class="section-title" data-aos="fade-up">Политика использования файлов cookie</h1>
            ...
            <div class="legal-content">
                ...
                <div class="legal-section" data-aos="fade-up" data-aos-delay="150">
                    ...
                    <p>
                        ...
                        (язык, настройки региона Германия и другие параметры) 
                        в течение определенного времени для обеспечения бесшовного IT-обучения.
                    </p>
                </div>
                ...
                <div class="legal-section" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <ul class="legal-list">
                        <li>
                            ...
                            <div><strong>Строго необходимые:</strong> Критически важны для функционирования систем авторизации и доступа к курсам.</div>
                        </li>
                        <li>
                            <i data-lucide="bar-chart-3"></i>
                            <div><strong>Аналитические:</strong> Сбор анонимной информации о том, как пользователи взаимодействуют с интерфейсом платформы.</div>
                        </li>
                        <li>
                            <i data-lucide="settings-2"></i>
                            <div><strong>Функциональные:</strong> Позволяют запоминать ваш прогресс в обучении и выбранные AI-инструменты.</div>
                        </li>
                        <li>
                            <i data-lucide="target"></i>
                            <div><strong>Маркетинговые:</strong> Помогают нам показывать только релевантные предложения, активные в странах ЕС.</div>
                        </li>
                    </ul>
                </div>

                <div class="legal-section" data-aos="fade-up" data-aos-delay="250">
                    ...
                    <ul class="simple-list">
                        ...
                        <li>Персонализация контента на базе инноваций для пользователей в Европе.</li>
                        <li>Предоставление экспертной поддержки в реальном времени.</li>
                    </ul>
                </div>
                ...
                <div class="legal-section" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <p>
                        Вы имеете полный контроль над данными. Вы можете в любой
                        момент изменить настройки в браузере. Однако, обратите
                        внимание: ограничение строго необходимых cookie может привести к
                        некорректной работе интерактивных элементов (3D-карточек и Canvas-анимаций).
                    </p>
                </div>
                ...
                <div class="contact-info-block" data-aos="zoom-in-up">
                    ...
                    <p>
                        Если у вас возникли вопросы касательно данной политики на <strong><?= $domainTitle ?></strong>, свяжитесь с нашей командой:
                    </p>
